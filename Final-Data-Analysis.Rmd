...
df = data_frame(Name = colnames(data), VarType = var.type, Nunique = n.unique, NMissing = n.missing, NBlank = n.blank, NBlankOrMissing = n.blankormissing, PercMissing = perc.missing)

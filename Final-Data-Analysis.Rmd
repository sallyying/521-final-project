...
) %>% select(logprice, Shape, log.Surface, Height_in, Width_in, year, High_Roller, Nfigures, Material, position) %>% na.omit()
...
lapply(data.train, function(x) sum(is.na(x)))


min(data.train$Height_in)

...
library(glmnet)
library(knitr)
>>>>>>> ffec0a542a9441748fb073951986d72f6ba80dd3
```
...
data.trainh2o = as.h2o(data.train)
#summary(data.trainh2o)

# split into train, test  
splits <- h2o.splitFrame(data = data.trainh2o, 
                         ratios = 0.7,  
                         seed = 9)  
train <- splits[[1]]
test <- splits[[2]]
...
for (i in seq(1,1301,by=100))
{
  ...
  datate=data.trainh2o[testind,]
  datatr=data.trainh2o[-testind,]
  gbm_fit <- h2o.gbm(y = y, x=x,
                  ...
                  seed = 9)
  Mse=Mse+mse(exp(h2o.predict(gbm_fit,newdata = datate[,-1])),exp(datate$logprice))
}
  gbmrmse=sqrt(Mse)
